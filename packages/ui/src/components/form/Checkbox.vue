  ...
  <div class="relative flex items-start">
    <div class="flex h-5 items-center">
      <input 
        ...
        :checked="modelValue"
        :disabled="disabled"
        class="h-5 w-5 rounded border-neutral-700 bg-neutral-800 text-primary-600 focus:ring-1 focus:ring-primary-500/40 focus:border-primary-500 disabled:opacity-60 disabled:bg-neutral-700 transition-all duration-200 cursor-pointer"
        @change="updateValue"
...
const getTestId = () => {
  return props.testId || `checkbox-${props.name}`;
};
</script> 